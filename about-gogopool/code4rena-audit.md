...
16. Bnke0x0
17. Breeje
18. [Ch_301](https://twitter.com/0xch301)
...
81. kartkhira
82. [kiki_dev](https://twitter.com/Kiki_developer)
83. koxuan
...
> The Warden has shown an issue with the FSM, Pools are allowed to perform the following transition<br> > `Prelaunch->Launched->Staking->Error->Finished->Prelaunch` which allows to spin up the pool without funds.
>
